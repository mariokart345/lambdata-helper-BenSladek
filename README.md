...
<blockquote>null_count(dataframe)</blockquote>
Removing outliers via interquartile ranges<br>
<blockquote>rm_outlier(dataframe_column)</blockquote>
Randomizing index<br>
<blockquote>randomize(dataframe,seed)<br>
seed for reproducibility</blockquote>
Test, train split of dataframe
<blockquote>test_train_split(dataframe,frac=0.2)<br>
